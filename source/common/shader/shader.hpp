...
namespace our {
    ...
    public:
        ...
        // We delete them because this class owns a unique OpenGL program handle.
        // Copying would make multiple objects manage the same handle and can cause
        // double deletion or accidental use-after-delete of the OpenGL program.
