...
class EntityTestState: public our::State {
    ...
    void onDraw(double deltaTime) override {
        ...
        // VP = Projection * View (both come from the camera component)
        ...
        for(auto& entity : world.getEntities()){
            ...
            // 1. Setup the material (sets shader, pipeline state, sends tint/texture uniforms)
            meshRenderer->material->setup();
            // 2. Send the full transform: clip = VP * localToWorld * vertexPosition
